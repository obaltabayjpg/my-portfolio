...
// Компонент AdminPanel (найдите этот компонент и ЗАМЕНИТЕ его на код ниже)
...
export default function App() {
  ...
  const categories = [
    {
      title: 'Соло работа',
      description: 'Индивидуальные проекты и консультации',
      gradient: 'from-blue-900/50 to-blue-800/30',
      onClick: () => setShowSoloWork(true)
    },
    {
      title: 'Командные проекты',
      description: 'Работа в составе команды',
      gradient: 'from-purple-900/50 to-purple-800/30',
      onClick: () => alert('Модальное окно для командных проектов')
    },
    {
      title: 'Корпоративные решения',
      description: 'Разработка для бизнеса',
      gradient: 'from-emerald-900/50 to-emerald-800/30',
      onClick: () => alert('Модальное окно для корпоративных решений')
    },
    {
      title: 'Обучение',
      description: 'Менторство и курсы',
      gradient: 'from-violet-900/50 to-violet-800/30',
      onClick: () => alert('Модальное окно для обучения')
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <AnimatePresence>
        {!hasEnteredGate && (
          <VisitorGate onSubmit={() => setHasEnteredGate(true)} />
        )}
      </AnimatePresence>
      ...
      >
        ...
        >
          ...
          <p className="text-xl text-zinc-400 font-light">
            Создаю премиальные цифровые продукты
          </p>
        </motion.div>
